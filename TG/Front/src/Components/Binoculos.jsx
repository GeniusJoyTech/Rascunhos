...
const handleClick = () => {
    var elementos = document.querySelectorAll('#atividade, #roteiro, #foto');
    elementos.forEach(function(elemento) {
        elemento.style.display = 'none';
      });
      var produto = document.getElementById('roteiro');
      produto.style.display = 'block';
};

function Binoculos() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000000" viewBox="0 0 256 256" onClick={handleClick}>
