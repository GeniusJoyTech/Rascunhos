...
const PeaoB = (props) => {
    ...
    return (
        <>
            <svg id={id} className='peca peao b' enableBackground="new 0 0 100 100" height="100px" version="1.1" viewBox="0 0 100 100" width="100px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><g id="white_exp">
